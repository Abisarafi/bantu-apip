                            ...
                            <form action="{{ route('employees.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="working_hour_target"
                                        name="working_hour_target" value="">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="phone_number"
                                            name="phone_number" placeholder="Masukkan nomor telepon tanpa 0 di depan"
                                            value="">
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-sm btn-primary">Tambah Karyawan</button>
                                </div>
                            </form>
                        </div>
